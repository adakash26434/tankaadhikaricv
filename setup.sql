...
('cloud','Web Hosting','From NPR 20,000 /year',2,1,'20,000','NPR /year','Nepal-based servers\n99.9% uptime guarantee\nFree SSL certificate\nDaily backups\ncPanel / managed options','violet','Get Hosting →','#contact'),
('envelope','Professional Email Hosting','From NPR 25,000 /year',3,1,'25,000','NPR /year','Your domain @you.com\nyourname@yourdomain.com\n5 GB storage per mailbox\nWebmail + IMAP/SMTP\nSpam & virus protection','yellow','Setup Email →','#contact'),
('shield-alt','Cyber Security Training','NPR 30,000 - Per person',4,1,'30,000','NPR','Group discounts available\nNetwork & endpoint security\nPhishing awareness\nData privacy & compliance\nIncident response basics','red','Enroll Now →','#contact');
